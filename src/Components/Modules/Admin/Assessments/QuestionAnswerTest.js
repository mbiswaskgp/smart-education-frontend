...
// 
const QuestionAnswerTest = (props) => {
        ...
        CommonService.getById('questionAnswer', id)
            .then(response => {
                if (response.data.success) {
                    ...
                    console.log(response.data.data.questionAnswer.file_type);
                    showFile(id);
                    ...
                    <CustomLoader /> : 
                        <Form onSubmit={handleSubmit}>
                            <div className="">
                                ...
                                <Form.Row>
                                    {/* <Form.Group controlId="formSubject" className="col-md-12">
...
export default withRouter(QuestionAnswerTest);