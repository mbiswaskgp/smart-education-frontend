...
function LearnerDashboard(props) {
    ...
    const getLearnerActiveAssessments = (limit, offset, sort, searchTitle) => {
        setLoader(true); 
        CommonService.getAllWithPage('learnerActiveAssessment',{ limit, offset, sort,searchTitle })
        .then(response => {
                            ...
                            <div className="col-md-12 col-12 mt-3">
                                        ...
                                        <tbody>
                                            {learners &&
                                                ...
                                                <tr key={learner.id}>
                                                    ...
                                                    <td>Complete by {learner.active_formated_end_date}</td>       
                                                    <td>
                                                        {(learner.status!='completed')?
                                                        <Link to={"/learner/exam/" + learner.id} className="detailsSection"> Begin Assessment <i className="fa fa-angle-right"></i></Link>:''
                                                        }
                                                    </td>
                                                </tr>
                                            ))
                                ...
                                <div className="rows">
                                    ...
                                    <div className="col-md-4 col-4">
                                        <Link to="/learner/completed-assessments"> Completed Assessments <i className="fa fa-arrow-right" aria-hidden="true"></i> </Link>
                                    </div>
                                </div>                          
                            </div>   
                        </div>
